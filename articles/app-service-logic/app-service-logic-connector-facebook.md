<properties
   pageTitle="Via de Facebook-Connector in logica Apps | Microsoft Azure App Service"
   description="Maken en de Facebook-Connector of API app configureren en gebruiken in een logica in Azure App Service app"
   services="logic-apps"

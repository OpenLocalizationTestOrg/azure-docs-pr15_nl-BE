<properties
   pageTitle="Met behulp van de SMTP-Connector in logica Apps | Microsoft Azure App Service"
   description="Het maken en configureren van de SMTP-Connector of API-app en gebruiken in een logica in Azure App Service app"
   services="logic-apps"

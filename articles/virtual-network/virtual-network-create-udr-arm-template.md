<properties 
   pageTitle="Routering beheren en virtuele toestellen in bronbeheer gebruiken met behulp van een sjabloon | Microsoft Azure"
   description="Informatie over het beheren van Routering en virtuele toestellen in Azure Resource Manager gebruiken met behulp van een sjabloon"
...
#<a name="create-user-defined-routes-udr-in-resource-manager-by-using-a-template"></a>Gebruiker gedefinieerde Routes (UDR) in Resource Manager maken met behulp van een sjabloon

[AZURE.INCLUDE [virtual-network-create-udr-arm-selectors-include.md](../../includes/virtual-network-create-udr-arm-selectors-include.md)]

[AZURE.INCLUDE [virtual-network-create-udr-intro-include.md](../../includes/virtual-network-create-udr-intro-include.md)]

[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]Dit artikel heeft betrekking op het implementatiemodel Resource Manager. 

[AZURE.INCLUDE [virtual-network-create-udr-scenario-include.md](../../includes/virtual-network-create-udr-scenario-include.md)]

## <a name="udr-resources-in-a-template-file"></a>Resources in een sjabloonbestand UDR

U kunt bekijken en downloaden van de [voorbeeldsjabloon](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR).

De sectie hieronder toont de definitie van de front-end UDR in het bestand **azuredeploy, vnet, nsg, udr.json** , op basis van het bovenstaande scenario.
...
De UDR naar het subnet-front-end gekoppeld, hebt u de definitie van subnet in de sjabloon wijzigen en de referentie-id voor de UDR.
...
Ook moet u ervoor zorgen dat de VM **FW1** de eigenschap ingeschakeld op de Netwerkkaart die wordt gebruikt heeft voor het ontvangen en doorsturen van pakketten doorsturen IP. De onderstaande sectie bevat de definitie van de NIC voor FW1 in het bestand azuredeploy-nsg-udr.json, op basis van het bovenstaande scenario.
...
2. Voer het `New-AzureRmResourceGroup` cmdlet een resourcegroep te maken.

        New-AzureRmResourceGroup -Name TestRG -Location westus

3. Voer het `New-AzureRmResourceGroupDeployment` cmdlet voor de implementatie van de sjabloon.
...
3. Vanuit uw browser, Ga naar **https://raw.githubusercontent.com/telmosampaio/azure-templates/master/IaaS-NSG-UDR/azuredeploy.parameters.json**, Kopieer de inhoud van het bestand json en in een nieuw bestand op uw computer plakken. In dit scenario zou u de waarden onder kopiëren naar een bestand met de naam **c:\udr\azuredeploy.parameters.json**.
...
4. Voer de cmdlet **azure groep maken** voor de implementatie van de nieuwe VNet met behulp van de sjabloon en parameter bestanden u hebt gedownload en hierboven is gewijzigd. De lijst die wordt weergegeven nadat u de parameters die worden gebruikt door de uitvoer wordt uitgelegd.
...
5. Voer de opdracht **azure groep weergeven** om de bronnen die zijn gemaakt in de nieuwe resourcegroep weer te geven. 
...
>[AZURE.TIP] Als u alle resources niet ziet, voert de `azure group deployment show` opdracht om ervoor te zorgen de inrichting staat van de implementatie van *Succeded*is.
<properties 
    pageTitle="Geavanceerde codering met Media Encoder Standard | Microsoft Azure" 
...
In deze sectie gesprekken voert over het wijzigen van de encoder-voorinstellingen om te knippen of snijd de input video waarin de invoer een zogenaamde mezzanine of bestand op aanvraag is. Het coderingsprogramma kan ook worden gebruikt om te knippen of snijden van een actief is opgenomen of van een live gegevensstroom is gearchiveerd – de details voor deze beschikbaar zijn in [deze blog](https://azure.microsoft.com/blog/sub-clipping-and-live-archive-extraction-with-media-encoder-standard/).

Om uw video's bijsnijden, kunt u een van de MES voorinstellingen gedocumenteerde [hier](https://msdn.microsoft.com/library/mt269960.aspx) en het element van de **bronnen** wijzigen (zoals hieronder). De waarde van de starttijd moet overeenkomen met de absolute tijdstempels van de video input. Bijvoorbeeld, als het eerste frame van de video input een tijdstempel van de 12:00:10.000 heeft, vervolgens StartTime moet ten minste 12:00:10.000 en hoger. In het volgende voorbeeld nemen we aan dat de invoer video een tijdstempel begin van nul heeft. Houd er rekening mee dat de **bronnen** aan de bovenkant van het schema moet worden geplaatst. 
...
>
>Uw FLV-bronbestand en het overlay-bestand moeten zich in hetzelfde actief.
...
Standaard als u een met het coderingsprogramma met alleen video en geen audio-invoer verzendt bevat vervolgens de activa van de uitvoer bestanden die alleen videogegevens bevatten. Sommige spelers mogelijk geen dergelijke uitvoerstromen verwerken. Deze instelling kunt u ervoor zorgen dat het coderingsprogramma een stille audio track toevoegen aan de uitvoer in dat scenario.

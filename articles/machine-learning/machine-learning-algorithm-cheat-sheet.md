<properties
    pageTitle="Machine het leren algoritme bedriegen blad | Microsoft Azure"
    description="Een afdrukbare machine leren algoritme bedriegen blad helpt u het juiste algoritme voor de voorspellende model kiezen in Azure Machine Learning Studio."
...
# <a name="machine-learning-algorithm-cheat-sheet-for-microsoft-azure-machine-learning-studio"></a>Machine learning algoritme bedriegen blad voor Azure Machine Learning Studio

Het **Microsoft Azure Machine Learning algoritme cheats blad** helpt u bij het juiste algoritme voor een anticiperende analytische model kiezen.

[Azure Machine Learning Studio](https://studio.azureml.net/) heeft een grote bibliotheek met algoritmen uit de ***regressie***, ***classificatie***, ***clustering***en families ***afwijking detecteren*** . Elk is ontworpen om een ander type machine learning probleem.


## <a name="download-machine-learning-algorithm-cheat-sheet"></a>Download: Machine learning algoritme bedriegen blad

**Het blad bedriegen hier downloaden: [Machine Learning algoritme cheats blad (11 x 17 inch)](http://download.microsoft.com/download/A/6/1/A613E11E-8F9C-424A-B99D-65344785C288/microsoft-machine-learning-algorithm-cheat-sheet-v6.pdf)**
...
Downloaden en afdrukken van de Machine Learning algoritme cheats blad in tabloid-formaat om te voorkomen dat deze bij de hand en hulp bij het kiezen van een algoritme.

> [AZURE.NOTE] Zie het artikel [het algoritmen voor Microsoft Azure Machine Learning kiezen](machine-learning-algorithm-choice.md) voor een uitgebreide handleiding voor het gebruik van dit blad bedriegen.

## <a name="more-help-with-algorithms"></a>Meer informatie over de algoritmen

* Zie voor een uitgebreidere bespreking van verschillende soorten machine learning algoritmen, hoe deze worden gebruikt en hoe u dit blad bedriegen voor het kiezen van de juiste algoritme [algoritmen voor Microsoft Azure Machine leren kiezen](machine-learning-algorithm-choice.md).

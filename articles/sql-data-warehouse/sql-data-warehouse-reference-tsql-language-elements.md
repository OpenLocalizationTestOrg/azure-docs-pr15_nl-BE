<properties
   pageTitle="Elementen van de taal SQL gegevens magazijn Transact-SQL | Microsoft Azure"
   description="Lijst met koppelingen naar de inhoud van de taalelementen van Transact-SQL voor SQL Data Warehouse gebruikt."
...
## <a name="core-elements"></a>Basiselementen

- [syntaxis van de verdragen](https://msdn.microsoft.com/library/ms177563.aspx)
...
- [IDENTITEIT eigenschap oplossing](https://msdn.microsoft.com/library/ms186775.aspx)
...
- [+ (Tekenreeksen)](https://msdn.microsoft.com/library/ms177561.aspx)
...
## <a name="wildcard-characters-to-match"></a>Tekens overeenkomen met jokertekens
...
- [> = (great dan of gelijk aan)](https://msdn.microsoft.com/library/ms181567.aspx)
...
- [! = (Is niet gelijk aan)](https://msdn.microsoft.com/library/ms190296.aspx)
...
- [[GEEN] IS NULL](https://msdn.microsoft.com/library/ms188795.aspx)
...
- [~ (Bitsgewijze NOT)](https://msdn.microsoft.com/library/ms173468.aspx)
- [^ = (Bitsgewijze exclusieve of gelijk aan)](https://msdn.microsoft.com/library/cc627413.aspx)
...
- [Scalaire functies voor ODBCS](https://msdn.microsoft.com/library/bb630290.aspx)
- [VIA de component](https://msdn.microsoft.com/library/ms189461.aspx)
...
- [VOEDING](https://msdn.microsoft.com/library/ms174276.aspx)
...
- [VIERKANT](https://msdn.microsoft.com/library/ms173569.aspx)
...
- [HET AANTAL RIJEN INSTELLEN](https://msdn.microsoft.com/library/ms188774.aspx)

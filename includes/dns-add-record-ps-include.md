...
In dit voorbeeld gebruiken we de naam van de record "@" voor het maken van een MX-record op de top van de zone (in dit geval 'contoso.com'). Dit is vaak de MX-records.
...
Als u een SRV-record in de hoofdmap van een zone maken wilt, gewoon opgeven *_service* en *_protocol* in de recordnaam van de. Het is niet nodig om op te nemen "@" in de recordnaam van de.
...
### <a name="create-a-txt-record-set-with-a-single-record"></a>Maak een TXT-record met een enkele record instellen
